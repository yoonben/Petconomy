				...
				<form name="signinForm" id="signinForm"
					...
					<div class="login-menu">
						...
						<div class="login-menu_right">
							<a class="mt-5 mb-3 text-muted" id='btnPasswordResetView'>비밀번호
								찾기</a>
						</div>
						...
						<form>
							...
							<div class="form-group email-form">
								<div class="input-group">
									<input type="text" class="form-control" name="userEmail123"
										id="userEmail123" placeholder="이메일">
								</div>
								<div class="form-login">
									<div class="input-group-addon">
										<button type="button" class="btn btn-primary"
											id="mail-Check-Btn2">본인인증</button>
									</div>
									<div class="mail-check-box2">
										<input class="form-control mail-check-input2"
				...
				<form name='signupForm' id='signupForm'
					...
					<c:if test="${empty showSignupForm}">
						<div class="form-login">
							...
							<div class="text-btn">
								<button class="btn btn-warning" type="button" id="btnid">중복
									확인</button>
							</div>
						</div>
					</c:if>
					...
					<div class="form-login">
						...
						<div class="text-btn">
							<button class="btn btn-warning" type="button" id="btnNickName">중복
								확인</button>
						</div>
					</div>
					...
					<div class="form-login">
						<label for="signUpPwCheck" style="color: #ec6090;">프로필첨부</label> <input
